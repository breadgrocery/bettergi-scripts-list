...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/workflow.js
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/asserts.js
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/exception.js
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/file.js
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/mouse.js
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/ocr.js
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/game.js
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/misc.js
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/time.js
var getNextDay4AM = () => {
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/progress.js
...
// node_modules/.pnpm/@bettergi+utils@0.1.14/node_modules/@bettergi/utils/dist/store.js
var useStore = (name) => {
...
(async function() {
  ...
  try {
    ...
    //! 迭代添加好友
    const tracker = new ProgressTracker(s_quota);
    for (let i = 0; i < uids.length; i++) {
      try {
        const attempts = s_force ? tracker.current : segment.daily.attempts;
        if (attempts >= s_quota) {
          tracker.complete("今日好友申请已达上限，脚本结束运行");
          break;
        }
        tracker.print("等待脚本运行结束...", true);
        //! 打开添加好友页面
